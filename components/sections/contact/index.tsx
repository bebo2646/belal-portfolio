...
export default function ContactSection() {
  ...
  return (
    <div ref={ref} id="contact" className="w-full container py-32">
      ...
      <div className="flex items-center justify-around w-full h-full gap-8 flex-col lg:flex-row">
        {gameTurnsLeft > 0 && (
        ...
        <motion.div layout className="w-full max-w-[450px] h-fit rounded-2xl bg-muted border overflow-hidden">
